package com.example.qlphontro.SQLHandle;
...
public class SQLHelper extends SQLiteOpenHelper {
    ...
    public void updatePasswordUser(String username, String newPassword) {
        ...
        sqLiteDatabase.update(DB_TABLE_TK, contentValues, "username=?", new String[]{username + ""});
        sqLiteDatabase.close();
    }

    public void updateProfileUser(String username, String fullname, String phone, String address, String dob) {
        sqLiteDatabase = getWritableDatabase();
        contentValues = new ContentValues();
