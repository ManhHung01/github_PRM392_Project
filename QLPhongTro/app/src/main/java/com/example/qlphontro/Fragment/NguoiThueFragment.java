                ...
                btnDN.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (username.compareTo("")==0||password.compareTo("")==0||rePassword.compareTo("")==0||
                            ...
                            tvError.setText("Please enter enough information");
                        }else if (password.compareTo(rePassword)!=0){
                            tvError.setText("Password must match");
                        }else {
                            ...
                            nguoiThueAdapter.setList(taiKhoanList);
                            Toast.makeText(getContext(), "Add tenant account successfully", Toast.LENGTH_SHORT).show();
                            dialog.cancel();
                        }
                    }
                });
